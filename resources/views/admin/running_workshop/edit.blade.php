<x-admin-layout>
  ...
  <x-slot name="header">
      <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <a class="breadcrumb-item" href="{{ route('admin.running_workshop.index') }}">إدارة إعلانات الوظائف</a>
          <span class="breadcrumb-item active">{{ $running_workshop->title_ar }}</span>
  ...
  <div class="card pd-25">
    ...
    <form action="{{ route('admin.running_workshop.update', ['running_workshop' => $running_workshop->id]) }}" method="post" enctype="multipart/form-data">
      @csrf
      @method('PATCH')
            ...
            <div class="row mg-b-25">
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <select name="workshop_id" id="" class="form-control">
                    ...
                    <option {{ $running_workshop->workshop_id== $workshop->id ? 'selected' : '' }} value="{{ $workshop->id }}">{{ $workshop->title_ar }}</option>
                    @endforeach
                  </select>
                </div>
              </div><!-- col-4 -->
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="price_sdg" value="{{ $running_workshop->price_sdg }}" placeholder="5000">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="form-control-label">السعر بالدولار: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="price_dollar" value="{{ $running_workshop->price_dollar }}" placeholder="100">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="form-control-label">تاريخ البداية: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="date" name="start_date" value="{{ $running_workshop->start_date }}" placeholder="ادخل عنوان الإعلان بالعربي">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="form-control-label">تاريخ النهاية: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="date" name="finish_date" value="{{ $running_workshop->finish_date }}" placeholder="ادخل عنوان الإعلان بالانجليزي">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">عدد ساعات المحاضرة: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="number" name="lecture_hours" value="{{ $running_workshop->lecture_hours }}" placeholder="2">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">عدد الساعات الكلي للورشة: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="total_hours" value="{{ $running_workshop->total_hours }}" placeholder="20">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">المكان: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="location" value="{{ $running_workshop->location }}" placeholder="مبنى الوكالة">
                </div>
              </div><!-- col-4 -->
            </div>
          </div><!-- tab-pane -->

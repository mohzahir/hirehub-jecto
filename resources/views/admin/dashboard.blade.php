    ...
    <div class="col-sm-6 col-xl-3">
      <div class="bg-info rounded overflow-hidden">
        <div class="pd-x-20 pd-t-20 d-flex align-items-center">
          <i class="ion ion-ios-briefcase tx-60 lh-0 tx-white op-7"></i>
          <div class="mg-r-20">
      ...
      <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
        <div class="bg-purple rounded overflow-hidden">
          <div class="pd-x-20 pd-t-20 d-flex align-items-center">
            ...
            <div class="mg-r-20">
              <p class="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase tx-white-8 mg-b-10">عدد العملاء المسجلين</p>
              <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ App\Models\Candidate::count() }}</p>
              <!-- <span class="tx-11 tx-roboto tx-white-8">65.45% on average time</span> -->
            </div>
          </div>
          <div id="ch4" class="ht-50 tr-y-1"></div>

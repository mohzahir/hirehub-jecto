<x-admin-layout>
  ...
  <div class="card pd-25">
    ...
    <form action="{{ route('admin.workshop.update', ['workshop' => $workshop->id]) }}" method="post" enctype="multipart/form-data">
      @csrf
      @method('PATCH')
            ...
            <div class="row mg-b-25">
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <select name="category_id" id="" class="form-control">
                    ...
                    <option {{ $workshop->category_id == $category->id ? 'selected' : '' }} value="{{ $category->id }}">{{ $category->title_ar }}</option>
                    @endforeach
                  </select>
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="title_ar" value="{{ $workshop->title_ar }}" placeholder="ادخل عنوان الوظيفة بالعربي">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="form-control-label">العنوان بالانجليزي: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="title" value="{{ $workshop->title }}" placeholder="ادخل عنوان الوظيفة بالانجليزي">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-12">
                ...
                <div class="form-group">
                  <input id="customFile" class="custom-file-input" type="file" name="photo" value="{{ $workshop->photo }}">
            ...
            <div class="row mg-b-25">
              <div class="col-lg-12">
                <div class="form-group mg-b-10-force">
                  ...
                  <textarea class="form-control summernote" type="text" name="description_ar" placeholder="ادخل الوصف بالعربي">{{ $workshop->description_ar }}</textarea>
                </div>
              </div><!-- col-8 -->
              <div class="col-lg-12">
                <div class="form-group mg-b-10-force">
                  <label class="form-control-label">الوصف بالانجليزي: <span class="tx-danger">*</span></label>
                  <textarea class="form-control summernote" type="text" name="description" placeholder="ادخل الوصف بالانجليزي">{{ $workshop->description }}</textarea>
                </div>
              </div><!-- col-8 -->
            </div>
          </div><!-- tab-pane -->
            ...
            <div class="row mg-b-25">
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="trainer_name_ar" value="{{ $workshop->trainer_name_ar }}" placeholder="محمد زاهر عبدالله">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="form-control-label">الإسم بالانجليزي: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="trainer_name" value="{{ $workshop->trainer_name }}" placeholder="Mohammed zahir">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="form-control-label">المسمى الوظيفي بالعربي: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="trainer_job_title_ar" value="{{  $workshop->trainer_job_title_ar }}" placeholder="مهندس برمجيات">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="form-control-label">المسمى الوظيفي بالانجليزي: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="trainer_job_title" value="{{ $workshop->trainer_job_title }}" placeholder="Software Engineer">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-12">
                <div class="form-group mg-b-10-force">
                  <label class="form-control-label">الوصف بالعربي: <span class="tx-danger">*</span></label>
                  <textarea class="form-control summernote" type="text" name="trainer_descr_ar" placeholder="ادخل الوصف بالعربي">{{ $workshop->trainer_descr_ar }}</textarea>
                </div>
              </div><!-- col-8 -->
              <div class="col-lg-12">
                <div class="form-group mg-b-10-force">
                  <label class="form-control-label">الوصف بالانجليزي: <span class="tx-danger">*</span></label>
                  <textarea class="form-control summernote" type="text" name="trainer_descr" placeholder="ادخل الوصف بالانجليزي">{{ $workshop->trainer_descr }}</textarea>
                </div>
              </div><!-- col-8 -->
            </div>
          </div><!-- tab-pane -->

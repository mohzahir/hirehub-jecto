<x-admin-layout>
  ...
  <x-slot name="header">
      <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">إضافة وظيفة</span>
      </nav>
  </x-slot>
  <x-slot name="title">
            ...
            <div class="row mg-b-25">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="title_ar" value="{{ old('title_ar') }}" placeholder="ادخل عنوان الوظيفة بالعربي">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="form-control-label">العنوان بالانجليزي: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="title" value="{{ old('title') }}" placeholder="ادخل عنوان الوظيفة بالانجليزي">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-12">
                ...
                <div class="form-group">
                  <input id="customFile" class="custom-file-input" type="file" name="photo" value="{{ old('photo') }}" placeholder="ادخل عنوان الوظيفة بالانجليزي">
                  <label style="top: 213px;width: 200px;" class="custom-file-label m-3" for="customFile"></label>
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                <label class="ckbox">
                  <input type="checkbox" name="is_featured" {{ old('is_featured') ? 'checked' : ''}} value="1"><span>الوظيفة مميزة ؟ <small>الوظائف المميزة سيتم عرضها على الصفحة الرئيسية</small></span>
                </label>
              </div><!-- col-8 -->
            </div>
          </div><!-- tab-pane -->
            ...
            <div class="row mg-b-25">
              <div class="col-lg-12">
                <div class="form-group mg-b-10-force">
                  ...
                  <textarea class="form-control summernote" type="text" name="description_ar" placeholder="ادخل الوصف الكامل بالعربي">{{ old('description_ar') }}</textarea>
                </div>
              </div><!-- col-8 -->
              <div class="col-lg-12">
                <div class="form-group mg-b-10-force">
                  <label class="form-control-label">الوصف الكامل بالانجليزي: <span class="tx-danger">*</span></label>
                  <textarea class="form-control summernote" type="text" name="description" placeholder="ادخل الوصف الكامل بالانجليزي">{{ old('description') }}</textarea>
                </div>
              </div><!-- col-8 -->
            </div>
          </div><!-- tab-pane -->

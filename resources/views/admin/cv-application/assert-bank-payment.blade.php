<x-admin-layout>
    ...
    <x-slot name="header">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{ route('admin.cv-application.index') }}">إدارة الدفع البنكي</a>
        ...
        <div class="form-layout form-layout-1">
            <div class="tab-content" data-select2-id="31">
                <div id="basic-info" class="tab-pane fade show active " role="tabpanel" aria-labelledby="home-tab">
                    <div class="row mg-b-25">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input readonly class="form-control" type="text" name="duration" value="{{ $application->CVCategory->cv_price_sdg }}" placeholder="لا يوجد">
                            </div>
                        </div><!-- col-4 -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form id="confirmation_form" action="{{ route('admin.cv-application.update', ['cv_application' => $application->id]) }}" method="post">
                                @method('PATCH')
                                @csrf
                                ...
                                <a href="{{ route('admin.cv-application.index') }}" class="btn btn-warning">رجوع</a>
                            </form>
                        </div>
                    </div>
                </div><!-- tab-pane -->

                    ...
                    <div class="row mg-b-25">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input readonly class="form-control" type="text" value="{{ $application->CVCategory->title_ar }}" placeholder="ادخل عنوان الإعلان بالعربي">
                            </div>
                        </div><!-- col-4 -->
                        <div class="col-lg-6">
                            <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <div class="form-groub">
                                ...
                                <a href="{{ asset($application->cv) }}" style="width: 200px;height: 200px;display: block">معاينة السيرة الذاتية</a>
                            </div>
                        </div><!-- col-4 -->

                    ...
                    <div class="row mg-b-25">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input readonly class="form-control" type="text" name="title_ar" value="{{ $job->title_ar }}" placeholder="ادخل عنوان الإعلان بالعربي">
                            </div>
                        </div><!-- col-4 -->
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="form-control-label">العنوان بالانجليزي</label>
                                <input readonly class="form-control" type="text" name="title" value="{{ $job->title }}" placeholder="ادخل عنوان الإعلان بالانجليزي">
                            </div>
                        </div><!-- col-4 -->
                        <div class="col-lg-6">
                            <div class="form-groub">
                                <label for="">صورة الإعلان</label>
                                <img style="width: 200px;height: 200px;display: block" src="{{ asset($job->photo) }}" class="img-fluid img-thumbnail" alt="">
                            </div>
                        </div><!-- col-4 -->
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                            <label class="ckbox">
                                <input readonly disabled type="checkbox" name="is_featured" {{ $job->is_featured ? 'checked' : ''}} value="1"><span>الإعلان مميزة ؟ </span>
                            </label>
                        </div><!-- col-8 -->
                    </div>
                </div><!-- tab-pane -->
